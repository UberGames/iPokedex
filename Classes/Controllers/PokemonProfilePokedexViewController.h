//
//  PokemonProfilePokedexViewController.h
//  iPokedex
//
...
@interface PokemonProfilePokedexViewController : UITableViewController {
	NSInteger dbID;
...
@property (nonatomic, retain) NSArray *tableEntries;
